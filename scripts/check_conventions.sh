...
appendices/02-penalties.md appendices/03-weapon-overview.md \
appendices/04-referee-quick-reference.md"
fail=0
...
check_zero "americký pravopis"              '\b(center|meters|offense|penalized|organized)\b'
