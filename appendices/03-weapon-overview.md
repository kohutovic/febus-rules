...
| Double hits | priority rules decide | each scores a point, except thrust beats cut/slice (thrust only) | priority rules decide | as Rapier |
...
> [Technical & Equipment Standards](../02-equipment.md) prevail in case of
> doubt. Buckler: circular, diameter ≤ 40 cm, wooden or metallic, no studs or
> sharp edges.
