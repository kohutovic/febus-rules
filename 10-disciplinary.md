...
8.  Fencers must fence to their utmost ability in a sportsmanlike manner until the end of the
...
1. Refusal to award a hit actually made. Although a fencer may in fact have hit the opponent on
...
2. Award of a hit which has not in fact been received. A fencer may have a hit awarded against
...
3. Exclusion. A fencer who, while fencing, commits certain violent or vindictive actions against
...
2. Expulsion from the venue of the competition or the tournament.
   ...
   1. A fencer who is excluded from a tournament is no longer allowed to participate in any
      competition during that tournament, either at the same weapon or another.
   2. All participants or non-fencers who participate in or are present at a competition
...
4.  The penalties are as follows:
    ...
    2. a penalty point, indicated by a RED CARD with which the Referee identifies the fencer at fault.
...
5.  All warnings (YELLOW CARDS), penalty points (RED CARDS) and exclusions (BLACK CARDS) must be noted
...
1. The first infringement in the Third Group is penalised by a RED CARD (penalty point), even if the
