...
**D.1** Everyone taking part in or attending a fencing competition, including the spectators, must
...
**D.2** Everybody taking part in or present at a fencing competition must remain orderly and must not
...
**D.3** Any person who, for any reason, threatens or insults an official is eligible for immediate
   disqualification/expulsion from the premises.

**D.4** The Referee, and/or the Organising Team, on their own authority, can decide to expel from the
...
**D.5** By entering a fencing competition, fencers agree to observe the Rules and the decisions and
    instructions of the officials, to be respectful towards the Referees (Referee and Assistant),
    and to follow their orders.

**D.6** No fencer may take part in the competition if they refuse to fence against any other fencer
...
**D.7** The fencers, completely equipped, with all equipment conforming with the regulations and ready
    to fence, must be present at the time and place appointed for the beginning of the pool or
    direct elimination bout, or at the time appointed for the checking of their equipment
    before their bout, as well as during the competition, whenever the Referee requires it.

**D.8** When presenting themselves to fence a bout, the fencers must arrive on the arena completely
    ready to fence — regulation clothing, jacket fastened, hands gloved and holding the weapon.

**D.9** During a competition, if a fencer does not present themselves on the arena, ready to fence,
    when ordered to do so by the Referee:

- a) The fencer not present is penalised with a Yellow Card;
- b) A second call is made, one minute after the first call, followed by a Red Card for the
       fencer or team member not present;
- c) A third and last call is made, one minute after the second call, followed by elimination
       from the competition for the fencer not present.

**D.10** During or after a bout, even if the fencer has already left the arena, any act against the
    spirit of sportsmanship such as violently or dangerously throwing one’s mask (or any other piece
    of equipment) is penalised.

**D.11** The fencer, whether on or off the arena, must keep their mask on until the Referee calls
    ‘Halt!’. They must not address the Referee until the Referee has announced the decision.

**D.12** Fencers must fence to their utmost ability in a sportsmanlike manner until the end of the
...
**D.13** All bouts must remain courteous and fair. All irregular actions (e.g. violently jostling the
...
**D.14** Before the beginning of each bout, the two fencers must perform a fencer’s salute to their
...
**D.17** By accepting a position as Referee or Assistant, the person so designated agrees to respect the
...
**D.18** The Referee is responsible not only for the direction of the bout, the judging of hits and the
    checking of equipment, but equally for the maintenance of order in the bouts which they are
    refereeing.

**D.19** The Referee has the right to interrupt a bout if the play becomes confused or dangerous, or the
...
**D.20** As director of the bout and arbiter of hits, the Referee may, in accordance with the rules and —
...
**D.21** By reason of the right of jurisdiction which they have over all the fencers who participate in,
    ...
    accompany the fencers.

**D.22** Finally, they may recommend to the Organising Team all other penalties which they consider
...
**D.23** The Organising Team and the head of the Refereeing Team have jurisdiction over all the fencers
...
**D.24** All the decisions of the Organising Team or the Head of the Refereeing Team are immediately
   enforceable. No appeal against a decision can suspend that decision during the competition.

## Penalties

**D.25** There are distinct categories of penalty applicable to different sorts of offence.

- a) Penalties related to fencing, applicable to offences committed while fencing. These are:
    - i) refusal to award a hit actually made
    - ii) awarding a hit which has not in fact been received
    - iii) exclusion from the competition

- b) Disciplinary penalties applicable to offences concerned with maintenance of order, discipline
      or sportsmanship. These are:
    - i) awarding a hit which has not in fact been received
    - ii) exclusion from the competition
    - iii) exclusion from participation in the whole tournament
    - iv) expulsion from the venue of the competition
    - v) exclusion from events organised by the Federation or the specific Organising Team for a
         period of time.

**D.26** All these penalties can be applied by the competent authorities at a competition — the Referee,
   the Head of the Refereeing Team, and the Organising Team.

### Penalties Related to Fencing

**D.27** Refusal to award a hit actually made. Although a fencer may in fact have hit the opponent on
   the target, this hit may be disallowed, either because it did not arrive during the period of
   time during which fencing is allowed, or because the fencer had crossed the boundaries of the
   arena, or because violence was involved in the making of the hit, or because of other reasons as
   laid down in the Rules.

**D.28** Award of a hit which has not in fact been received. A fencer may have a hit awarded against
...
**D.29** Exclusion. A fencer who, while fencing, commits certain violent or vindictive actions against
   the opponent, or who does not fence to their utmost ability, or who profits from a fraudulent
   agreement with the opponent, may be excluded from the competition. A fencer who is excluded
...
**D.30** Exclusion from the Competition. It may also be imposed for a disciplinary offence (failure to
   appear on the arena as required, weapons not in accordance with the rules, reprehensible attitude
   towards an official, etc.). The consequences of such exclusion for the fencer are the same as
   those described in D.29 (Exclusion) above.

**D.31** Expulsion from the venue of the competition or the tournament.

- a) A fencer who is excluded from a tournament is no longer allowed to participate in any
      competition during that tournament, either at the same weapon or another.
- b) All participants or non-fencers who participate in or are present at a competition
...
**D.32** There are three types of penalty to be applied in the cases indicated in the
    [Table of Offences and Penalties](appendices/02-penalties.md).
...
**D.33** Penalties are cumulative and they are valid for the bout with the exception of those indicated
...
**D.34** Certain offences can result in the annulment of the hit scored by the fencer at fault. During
    the bout, only hits scored in circumstances connected with the offence may be annulled.

**D.35** The penalties are as follows:
...
**D.36** All warnings (YELLOW CARDS), penalty points (RED CARDS) and exclusions (BLACK CARDS) must be noted
    on the score-sheet of the bout, the pool or the direct-elimination bout, together with the group
    to which they belong.

**D.37** The offences and their penalties which appear in different articles of the Rules are summarised
    in the [Table of Offences and Penalties](appendices/02-penalties.md); they are divided into four groups. All these
...
**D.38** The first infringement in this First Group is penalised by a YELLOW CARD (warning). If during the
   same bout the fencer commits the same or a different offence in this group the Referee penalises
   them on each occasion, with a RED CARD (penalty point). If the fencer at fault has already been
...
**D.39** Every offence in the Second Group, including the first infringement, is penalised by a RED CARD
   (penalty point).

### The Third Group of Offences

**D.40** The first infringement in the Third Group is penalised by a RED CARD (penalty point), even if the
   fencer at fault has already received a RED CARD as a result of offences in the First or Second
   Groups.

**D.41** If during the same bout the fencer commits the same or a different offence in this group, they
...
**D.42** Any person not on the arena who disturbs the good order of the competition receives:

- a) On the first infringement, a warning, indicated by a YELLOW CARD, valid for the whole of the
...
- c) In the most serious cases concerning disturbance either on or off the arena, the Referee may
